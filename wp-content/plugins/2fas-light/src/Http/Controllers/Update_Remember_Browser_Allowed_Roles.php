...
class Update_Remember_Browser_Allowed_Roles extends Controller {
	...
	public function update( Request $request ): JSON_Response {
		$roles = $request->post( 'remember_browser_allowed_roles' );
		...
		$this->options_storage->set_remember_browser_allowed_roles( $roles );
