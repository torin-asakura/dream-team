...
import { initializeConfimationModal, initializeLanguageOldValue } from './lib/confirmation-modal'
...
jQuery(function ($) {
  $.ajaxPrefilter(function (options, originalOptions, jqXHR) {
    ...
    if (
      ...
      -1 !== options.url.indexOf('action=ajax-tag-search') &&
      lang
    ) {
...
jQuery(function ($) {
  ...
  tagBox.get = function (id) {
    ...
    $.post(ajaxurl, data, function (r, stat) {
      ...
      r = $('<div />')
        .addClass('the-tagcloud')
        .attr('id', 'tagcloud-' + tax)
        .html(r) // phpcs:ignore WordPressVIPMinimum.JS.HTMLExecutingFunctions.html
    ...
    dialogResult.then(
      () => {
        ...
        $.post(ajaxurl, data, function (response) {
          ...
          $('body')
            .removeClass('pll-dir-rtl')
            .removeClass('pll-dir-ltr')
            .addClass('pll-dir-' + dir)
 ...
 * @namespace
 */
var media = _.extend(pll.media /** @lends pll.media.prototype */, {
  /**
...
if ('undefined' !== typeof wp && 'undefined' !== typeof wp.media) {
   ...
   * @memberOf pll.media
   */
  media.query = _.extend(media.query /** @lends pll.media.query prototype */, {
    /**
