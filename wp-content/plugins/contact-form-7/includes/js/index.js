    ...
    var p = function (e) {
        ...
        return d.reduceRight(
          ...
          function (e) {
            ...
            'string' == typeof i &&
              ((t = o.replace(/^\/|\/$/g, '')), (c = (r = i.replace(/^\//, '')) ? t + '/' + r : t)),
              'string' == typeof c &&
                (-1 !== n.indexOf('?') && (c = c.replace('?', '&')),
                (c = c.replace(/^\//, '')),
                (a = n + c)),
              delete (s = f({ Accept: 'application/json, */*;q=0.1' }, s))['X-WP-Nonce'],
            ...
            return window
              .fetch(a || c || window.location.href, f(f({}, d), {}, { headers: s, body: l }))
              .then(
                function (e) {
        ...
        .then((t) => {
          ...
          return (
            ...
            ['invalid', 'unaccepted', 'spam', 'aborted'].includes(n)
              ? a(e, n, r)
              : ['sent', 'failed'].includes(n) && a(e, 'mail' + n, r),
            a(e, 'submit', r),
            t
          )
        })
      ...
      p({
        ...
        .then(function (t) {
          e.wpcf7.resetOnMailSent
            ? (delete e.wpcf7.resetOnMailSent, o(e, 'mail_sent'))
            : o(e, 'init'),
            (n.apiResponse = t),
            a(e, 'reset', n)
        })
