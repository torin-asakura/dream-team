          ...
          : ((d = {}),
            ...
            (A = function () {
              ...
              ;(c = {}),
                ...
                d.vars.active.index() % 2 === 0
                  ? ((e.left = a + '%'), (e.top = a + '%'), (c.left = '0%'), (c.top = '0%'))
                  : ((e.left = '0%'), (e.top = '0%'), (c.left = a + '%'), (c.top = a + '%')),
            ...
            (f = function () {
              if (
                (0 === a('.' + d.settings.fillerClass, d.vars.slideWrapper).length &&
                  d.vars.slideWrapper.append(a('<div class="' + d.settings.fillerClass + '" />')),
            ...
            (p = function () {
              d.settings.pager &&
                (a('.' + d.settings.pagerClass + ' li', d.vars.slippryWrapper).removeClass(
                  d.settings.activeClass
                ),
                a(
                  a('.' + d.settings.pagerClass + ' li', d.vars.slippryWrapper)[
                    d.vars.active.index()
                  ]
                ).addClass(d.settings.activeClass))
            }),
            (u = function () {
              !d.settings.loop &&
                d.settings.hideOnEnd &&
                (a('.' + d.settings.prevClass, d.vars.slippryWrapper)[
                  d.vars.first ? 'hide' : 'show'
                ](),
                a('.' + d.settings.nextClass, d.vars.slippryWrapper)[
                  d.vars.last ? 'hide' : 'show'
                ]())
            }),
            (i = function () {
              var b, c
              d.settings.captions !== !1 &&
                ((b =
                  'img' !== d.settings.captionsSrc
                    ? d.vars.active.attr('title')
                    : void 0 !== a('img', d.vars.active).attr('title')
                    ? a('img', d.vars.active).attr('title')
                    : a('img', d.vars.active).attr('alt')),
                (c =
                  'custom' !== d.settings.captions
                    ? a(d.settings.captionsEl, d.vars.slippryWrapper)
                    : a(d.settings.captionsEl)),
            ...
            (m = function () {
              ;(d.vars.moving = !1),
                ...
                d.settings.auto &&
                  ((d.vars.hoverStop && void 0 !== d.vars.hoverStop) || e.startAuto())
            }),
            (r = function () {
              var b, c, f, g, h, i, j
              d.settings.onSlideBefore.call(
                void 0,
                d.vars.active,
                d.vars.old.index(),
                d.vars.active.index()
                    ...
                    'fade' === d.settings.transition || 'kenburns' === d.settings.transition
                      ? (d.vars.fresh
                          ? (d.settings.useCSS
                              ...
                              : d.vars.slides.css({ opacity: 0 }),
                            d.vars.active.css('opacity', 1),
                            'kenburns' === d.settings.transition &&
                              d.settings.useCSS &&
                              ((h = d.settings.pause + 2 * d.settings.speed),
                          ...
                          : ('kenburns' === d.settings.transition && A(),
                            d.vars.old
                              .addClass(d.settings.transClass)
                              .animate(
                                { opacity: 0 },
                                d.settings.speed,
                                d.settings.easing,
                            ...
                            d.vars.active
                              .addClass(d.settings.transClass)
                              .css('opacity', 0)
                              .animate({ opacity: 1 }, d.settings.speed, d.settings.easing)),
                        s())
                      : ('horizontal' === d.settings.transition ||
                          'vertical' === d.settings.transition) &&
                              ...
                              (!d.vars.jump ||
                                ...
                                d.vars.first
                                  ? ((f = 0),
                                    ...
                                    (b = '-' + d.vars.count * (100 + d.settings.slideMargin) + '%'))
                                  : ((f =
                                      (d.vars.count - 1) * (100 + d.settings.slideMargin) + '%'),
                                    d.vars.active.css(i, -(100 + d.settings.slideMargin) + '%'),
                            ...
                            d.settings.useCSS
                              ? ((j[i] = b),
                                ...
                                e.one(d.vars.transition, function () {
                                  return (
                                    e.removeClass(d.settings.transition),
                                    c &&
                                      (d.vars.active.css(i, f),
                                      (j[i] = g),
                                      (j.transitionDuration = '0ms'),
                                      e.css(j)),
                                    m(),
                                    this
                                  )
                              ...
                              : ((j[i] = b),
                                e
                                  .stop()
                                  .animate(j, d.settings.speed, d.settings.easing, function () {
            ...
            (v = function (a) {
              ;(d.vars.first = d.vars.last = !1),
                'prev' === a || 0 === a
                  ? (d.vars.first = !0)
                  : ('next' === a || a === d.vars.count - 1) && (d.vars.last = !0)
            }),
            (t = function (b) {
              var c, f
              d.vars.moving ||
                ...
                'prev' === b ||
                  ...
                  (b === c && !d.vars.fresh) ||
                  (v(b),
                  (d.vars.old = d.vars.active),
                  (d.vars.active = a(d.vars.slides[b])),
                  ((0 === c && 'prev' === f) || (c === d.vars.count - 1 && 'next' === f)) &&
                    (d.vars.jump = !0),
                  r()))
            }),
            ...
            (j = function () {
              if (d.settings.pager && d.vars.count > 1) {
                var b, c, e
                for (
                  b = d.vars.slides.length,
                    e = a('<ul class="' + d.settings.pagerClass + '" />'),
                    c = 1;
                  b + 1 > c;
                  c += 1
                )
                  e.append(a('<li />').append(a('<a href="#' + c + '">' + c + '</a>')))
            ...
            (o = function () {
              d.settings.captions !== !1 &&
                ('overlay' === d.settings.captions
                  ? d.vars.slideWrapper.append(
                      a('<div class="sy-caption-wrap" />').html(z('<div />', d.settings.captionsEl))
                    )
                  : 'below' === d.settings.captions &&
                    d.vars.slippryWrapper.append(
                      a('<div class="sy-caption-wrap" />').html(z('<div />', d.settings.captionsEl))
                    ))
            }),
            (y = function () {
            ...
            (e.destroySlider = function () {
              d.vars.fresh === !1 &&
                ...
                d.vars.slides.each(function () {
                  void 0 !== a(this).data('sy-cssBckup')
                    ? a(this).attr('style', a(this).data('sy-cssBckup'))
                    : a(this).removeAttr('style'),
                    void 0 !== a(this).data('sy-classBckup')
                      ? a(this).attr('class', a(this).data('sy-classBckup'))
                      : a(this).removeAttr('class')
                }),
                void 0 !== e.data('sy-cssBckup')
                  ? e.attr('style', e.data('sy-cssBckup'))
                  : e.removeAttr('style'),
                void 0 !== e.data('sy-classBckup')
                  ? e.attr('class', e.data('sy-classBckup'))
                  : e.removeAttr('class'),
            ...
            (h = function () {
              ...
              return (
                ...
                d.settings.useCSS &&
                  (w('transition') || (d.settings.useCSS = !1), (d.vars.transition = n())),
                e.data('sy-cssBckup', e.attr('style')),
                e.data('sy-classBackup', e.attr('class')),
                e
                  .addClass(d.settings.boxClass)
                  .wrap(d.settings.slippryWrapper)
                  .wrap(d.settings.slideWrapper)
                  .wrap(d.settings.slideCrop),
                (d.vars.slideWrapper = e.parent().parent()),
                (d.vars.slippryWrapper = d.vars.slideWrapper
                  .parent()
                  .addClass(d.settings.loadingClass)),
                (d.vars.fresh = !0),
                d.vars.slides.each(function () {
                  a(this).addClass('sy-slide ' + d.settings.transition),
                    ...
                    'horizontal' === d.settings.transition
                      ...
                      : 'vertical' === d.settings.transition &&
                        a(this).css('top', a(this).index() * (100 + d.settings.slideMargin) + '%')
                }),
                d.vars.count > 1 || d.settings.initSingle
                  ? (-1 === a('.' + d.settings.activeClass, e).index()
                      ? ((f =
                          'random' === d.settings.start
                            ? Math.round(Math.random() * (d.vars.count - 1))
                            : d.settings.start > 0 && d.settings.start <= d.vars.count
                            ? d.settings.start - 1
                            : 0),
