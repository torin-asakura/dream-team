 ...
 * Build: http://modernizr.com/download/#-flexbox-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes
 */
window.Modernizr = (function (a, b, c) {
  ...
  return (
    ...
    (e.testStyles = w),
    (g.className =
      g.className.replace(/(^|\s)no-js(\s|$)/, '$1$2') + (f ? ' js ' + t.join(' ') : '')),
    e
  )
})(this, this.document)
