      ...
      if ('Element' in b) {
        ...
        var d = Object,
          ...
          a =
            ...
            function (l) {
              for (var f = 0, a = this.length; a > f; f++) if (f in this && this[f] === l) return f
              return -1
            },
          c = function (a, f) {
            this.name = a
        ...
        if (
          ...
          (e.remove = function () {
            ...
            do {
              var d = b[c] + ''
              for (a = h(this, d); ~a; ) this.splice(a, 1), (k = !0), (a = h(this, d))
            } while (++c < e)
  ...
  for (
    ...
    (window.requestAnimationFrame = window[d[g] + 'RequestAnimationFrame']),
      (window.cancelAnimationFrame =
        window[d[g] + 'CancelAnimationFrame'] || window[d[g] + 'CancelRequestAnimationFrame'])
