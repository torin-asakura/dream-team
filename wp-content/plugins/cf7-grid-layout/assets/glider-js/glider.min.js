  ...
  return (
    ...
    (o.bindDrag = function () {
      ...
      e.ele.classList.toggle('draggable', !0 === e.opt.draggable),
        e.event(e.ele, 'remove', o),
        e.opt.draggable && e.event(e.ele, 'add', o)
    }),
    ...
    (o.updateControls = function (e) {
      ...
      t.opt.rewind ||
        (t.arrows.prev && t.arrows.prev.classList.toggle('disabled', t.ele.scrollLeft <= 0 || o),
        t.arrows.next &&
          t.arrows.next.classList.toggle(
            'disabled',
            Math.ceil(t.scrollLeft + t.containerWidth) >= Math.floor(t.trackWidth) || o
          )),
        (t.slide = Math.round(t.scrollLeft / t.itemWidth)),
        (t.page = Math.round(t.scrollLeft / t.containerWidth))
      var i = t.slide + Math.floor(Math.floor(t.opt.slidesToShow) / 2),
        r = Math.floor(t.opt.slidesToShow) % 2 ? 0 : i + 1
      1 === Math.floor(t.opt.slidesToShow) && (r = 0),
        t.scrollLeft + t.containerWidth >= Math.floor(t.trackWidth) &&
          (t.page = t.dots ? t.dots.children.length - 1 : 0),
        [].forEach.call(t.slides, function (e, o) {
          var s = e.classList,
            l = s.contains('visible'),
            n = t.scrollLeft,
            a = t.scrollLeft + t.containerWidth,
            d = t.itemWidth * o,
            c = d + t.itemWidth
          ;[].forEach.call(s, function (e) {
            ;/^left|right/.test(e) && s.remove(e)
          }),
            s.toggle('active', t.slide === o),
            i === o || (r && r === o)
              ? s.add('center')
              : (s.remove('center'),
                s.add([o < i ? 'left' : 'right', Math.abs(o - (o < i ? i : r || i))].join('-')))
          var h = Math.ceil(d) >= n && Math.floor(c) <= a
          s.toggle('visible', h),
            h !== l && t.emit('slide-' + (h ? 'visible' : 'hidden'), { slide: o })
        }),
        t.dots &&
          [].forEach.call(t.dots.children, function (e, o) {
    ...
    (o.scrollItem = function (e, t, o) {
      ...
      if ((++i.animate_id, !0 === t))
        ...
        if ('string' == typeof e) {
          ...
          if (
            ((e =
              i.opt.slidesToScroll % 1 || i.opt.slidesToShow % 1 ? i.getCurrentSlide() : i.slide),
      ...
      return (
        i.scrollTo(e, i.opt.duration * Math.abs(i.ele.scrollLeft - e), function () {
          i.updateControls(),
            i.emit('animated', {
              value: r,
    ...
    (o.settingsBreakpoint = function () {
      ...
      if (o) {
        ...
        for (var i = 0; i < o.length; ++i) {
          var r = o[i]
          if (e.innerWidth >= r.breakpoint)
            return (
              t.breakpoint !== r.breakpoint &&
              ((t.opt = Object.assign({}, t._opt, r.settings)), (t.breakpoint = r.breakpoint), !0)
            )
        }
      }
    ...
    (o.scrollTo = function (t, o, i) {
      var r = this,
        ...
        n = function () {
          ...
          ;(r.scrollLeft = r.scrollLeft + (t - r.scrollLeft) * r.opt.easing(0, a, 0, 1, o)),
    ...
    (o.handleMouse = function (e) {
      ...
      t.mouseDown &&
        ((t.isDrag = !0),
        (t.scrollLeft += (t.mouseDown - e.clientX) * (t.opt.dragVelocity || 3.3)),
    ...
    (o.setOption = function (e, t) {
      var o = this
      o.breakpoint && !t
        ? o._opt.responsive.forEach(function (t) {
    ...
    (o.destroy = function () {
      ...
      ;(o.children[0].outerHTML = o.children[0].innerHTML),
        ...
        t.event(e, 'remove', { resize: t.resize }),
        t.emit('destroy')
    }),
    (o.emit = function (t, o) {
      var i = new e.CustomEvent('glider-' + t, { bubbles: !this.opt.eventPropagate, detail: o })
