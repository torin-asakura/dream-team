...
;(function (factory) {
    ...
    if (!_.opt.rewind) {
      ...
      if (_.arrows.next) {
        _.arrows.next.classList.toggle(
          'disabled',
          Math.ceil(_.scrollLeft + _.containerWidth) >= Math.floor(_.trackWidth) || disableArrows
        )
      }
    }
  ...
  gliderPrototype.scrollTo = function (scrollTarget, scrollDuration, callback) {
    ...
    var animate = function () {
      ...
      _.scrollLeft =
        _.scrollLeft + (scrollTarget - _.scrollLeft) * _.opt.easing(0, now, 0, 1, scrollDuration)
