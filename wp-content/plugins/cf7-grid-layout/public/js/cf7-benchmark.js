;(function ($) {
  ...
  $(document).ready(function () {
    ...
    $cf7Form.each(function () {
      if ($(this).is('div.cf7_2_post form.wpcf7-form')) {
        ...
        $(this).on(nonce, function () {
          //post my cf7 form plugin is ready.
  ...
  $.fn.cf7sgBenchmark = function (warn) {
    ...
    var msg =
      '<span class="cf7sg-benchmark-warning' +
      hidden +
      '"><span>warning<span class="dashicons dashicons-no-alt"></span></span><span class="cf7sg-benchmark-msg">' +
      $(this).data('cf7sg-benchmark-msg') +
      '</span></span>'
    switch (type) {
      case 'above':
        ...
        if ($(this).val() > limit) {
          $(this).after(msg)
          if (!warn)
            $(this).next('span.cf7sg-benchmark-warning').hide().find('.dashicons-no-alt').remove()
