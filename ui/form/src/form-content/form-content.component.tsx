...
import { FormContentProps }       from './form-content.interface'
import { Type }                   from './form-content.interface'
...
const FormContent: FC<FormContentProps> = ({ language, onSuccess, onFailure }) => {
  ...
  return (
    ...
    >
      <Column width='100%'>
        ...
        <Layout flexBasis={32} />
        <Button width='100%' onClick={sendForm}>
