...
/** The AboutItem type */
export type AboutItem = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfContentAddons & {
...
/** Connection between the AboutItem type and the AboutItem type */
export type AboutItemToPreviewConnectionEdge = AboutItemConnectionEdge & Edge & OneToOneConnection & {
...
export type CommonFragment = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
...
/** Connection between the CommonFragment type and the CommonFragment type */
export type CommonFragmentToPreviewConnectionEdge = CommonFragmentConnectionEdge & Edge & OneToOneConnection & {
...
export type ConfidentialityPolicy = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
...
/** Connection between the ConfidentialityPolicy type and the confidentialityPolicy type */
export type ConfidentialityPolicyToPreviewConnectionEdge = ConfidentialityPolicyConnectionEdge & Edge & OneToOneConnection & {
...
/** The Contact type */
export type Contact = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Contact';
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
...
export type ContactItem = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfContentAddons & {
...
/** Connection between the ContactItem type and the ContactItem type */
export type ContactItemToPreviewConnectionEdge = ContactItemConnectionEdge & Edge & OneToOneConnection & {
...
export type ContentAddons = AcfFieldGroup & AcfFieldGroupFields & ContentAddons_Fields & {
...
export type CustomerReview = AcfFieldGroup & AcfFieldGroupFields & CustomerReview_Fields & {
...
export type FeedbackItem = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfContentAddons & {
...
/** Connection between the FeedbackItem type and the FeedbackItem type */
export type FeedbackItemToPreviewConnectionEdge = Edge & FeedbackItemConnectionEdge & OneToOneConnection & {
...
/** The FooterItem type */
export type FooterItem = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfContentAddons & {
...
/** Connection between the FooterItem type and the FooterItem type */
export type FooterItemToPreviewConnectionEdge = Edge & FooterItemConnectionEdge & OneToOneConnection & {
...
/** The Fragment type */
export type Fragment = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithPageAttributes & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfFragments & {
  __typename?: 'Fragment';
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
...
/** Connection between the Fragment type and the Fragment type */
export type FragmentToPreviewConnectionEdge = Edge & FragmentConnectionEdge & OneToOneConnection & {
...
export type Fragments = AcfFieldGroup & AcfFieldGroupFields & Fragments_Fields & {
...
/** The HeroItem type */
export type HeroItem = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfContentAddons & {
  __typename?: 'HeroItem';
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  /** Fields of the ContentAddons ACF Field Group */
...
/** Connection between the HeroItem type and the HeroItem type */
export type HeroItemToPreviewConnectionEdge = Edge & HeroItemConnectionEdge & OneToOneConnection & {
...
/** The Main type */
export type Main = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfReviews & {
  __typename?: 'Main';
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
...
/** Connection between the Main type and the Main type */
export type MainToPreviewConnectionEdge = Edge & MainConnectionEdge & OneToOneConnection & {
...
export type MenuItemObjectUnion = AboutItem | Category | CommonFragment | ConfidentialityPolicy | Contact | ContactItem | FeedbackItem | FooterItem | Fragment | HeroItem | Main | Messenger | NavigationItem | NotFound | Page | Post | PrivacyPolicyItem | Recruit | RecruitList | Review | ReviewList | Skill | SkillCategory | SocialNetwork | Tag;
...
/** The Messenger type */
export type Messenger = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
...
/** Connection between the Messenger type and the Messenger type */
export type MessengerToPreviewConnectionEdge = Edge & MessengerConnectionEdge & OneToOneConnection & {
...
export type NavigationItem = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfContentAddons & {
...
/** Connection between the NavigationItem type and the NavigationItem type */
export type NavigationItemToPreviewConnectionEdge = Edge & NavigationItemConnectionEdge & OneToOneConnection & {
...
/** The NotFound type */
export type NotFound = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'NotFound';
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
...
/** Connection between the NotFound type and the NotFound type */
export type NotFoundToPreviewConnectionEdge = Edge & NotFoundConnectionEdge & OneToOneConnection & {
...
/** The post type */
export type Post = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithAuthor & NodeWithComments & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & NodeWithTrackbacks & Previewable & UniformResourceIdentifiable & WithAcfRecords & {
  __typename?: 'Post';
  /** Connection between the NodeWithAuthor type and the User type */
  author?: Maybe<NodeWithAuthorToUserConnectionEdge>;
  /** The database identifier of the author of the node */
...
export type PrivacyPolicyItem = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfContentAddons & {
...
/** Connection between the PrivacyPolicyItem type and the PrivacyPolicyItem type */
export type PrivacyPolicyItemToPreviewConnectionEdge = Edge & OneToOneConnection & PrivacyPolicyItemConnectionEdge & {
...
export type Records = AcfFieldGroup & AcfFieldGroupFields & Records_Fields & {
  __typename?: 'Records';
...
/** The Recruit type */
export type Recruit = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Recruit';
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
...
export type RecruitList = DatabaseIdentifier & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
...
/** Connection between the RecruitList type and the ContentNode type */
export type RecruitListToContentNodeConnection = Connection & ContentNodeConnection & {
...
/** An edge in a connection */
export type RecruitListToContentNodeConnectionEdge = ContentNodeConnectionEdge & Edge & {
...
export type RecruitListToContentNodeConnectionPageInfo = ContentNodeConnectionPageInfo & PageInfo & WpPageInfo & {
...
/** Connection between the RecruitList type and the Recruit type */
export type RecruitListToRecruitConnection = Connection & RecruitConnection & {
...
/** An edge in a connection */
export type RecruitListToRecruitConnectionEdge = Edge & RecruitConnectionEdge & {
...
export type RecruitListToRecruitConnectionPageInfo = PageInfo & RecruitConnectionPageInfo & WpPageInfo & {
...
/** Connection between the RecruitList type and the Taxonomy type */
export type RecruitListToTaxonomyConnectionEdge = Edge & OneToOneConnection & TaxonomyConnectionEdge & {
...
/** Connection between the Recruit type and the Recruit type */
export type RecruitToPreviewConnectionEdge = Edge & OneToOneConnection & RecruitConnectionEdge & {
...
/** Connection between the Recruit type and the recruitList type */
export type RecruitToRecruitListConnection = Connection & RecruitListConnection & {
...
/** An edge in a connection */
export type RecruitToRecruitListConnectionEdge = Edge & RecruitListConnectionEdge & {
...
export type RecruitToRecruitListConnectionPageInfo = PageInfo & RecruitListConnectionPageInfo & WpPageInfo & {
...
/** Connection between the Recruit type and the TermNode type */
export type RecruitToTermNodeConnection = Connection & TermNodeConnection & {
...
/** An edge in a connection */
export type RecruitToTermNodeConnectionEdge = Edge & TermNodeConnectionEdge & {
...
export type RecruitToTermNodeConnectionPageInfo = PageInfo & TermNodeConnectionPageInfo & WpPageInfo & {
...
/** The review type */
export type Review = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithPageAttributes & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfCustomerReview & {
  __typename?: 'Review';
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
...
/** The reviewList type */
export type ReviewList = DatabaseIdentifier & HierarchicalNode & HierarchicalTermNode & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
...
export type ReviewListToAncestorsReviewListConnection = Connection & ReviewListConnection & {
...
/** An edge in a connection */
export type ReviewListToAncestorsReviewListConnectionEdge = Edge & ReviewListConnectionEdge & {
...
export type ReviewListToAncestorsReviewListConnectionPageInfo = PageInfo & ReviewListConnectionPageInfo & WpPageInfo & {
...
/** Connection between the ReviewList type and the ContentNode type */
export type ReviewListToContentNodeConnection = Connection & ContentNodeConnection & {
...
/** An edge in a connection */
export type ReviewListToContentNodeConnectionEdge = ContentNodeConnectionEdge & Edge & {
...
export type ReviewListToContentNodeConnectionPageInfo = ContentNodeConnectionPageInfo & PageInfo & WpPageInfo & {
...
/** Connection between the ReviewList type and the reviewList type */
export type ReviewListToParentReviewListConnectionEdge = Edge & OneToOneConnection & ReviewListConnectionEdge & {
...
/** Connection between the ReviewList type and the review type */
export type ReviewListToReviewConnection = Connection & ReviewConnection & {
...
/** An edge in a connection */
export type ReviewListToReviewConnectionEdge = Edge & ReviewConnectionEdge & {
...
export type ReviewListToReviewConnectionPageInfo = PageInfo & ReviewConnectionPageInfo & WpPageInfo & {
...
/** Connection between the ReviewList type and the reviewList type */
export type ReviewListToReviewListConnection = Connection & ReviewListConnection & {
...
/** An edge in a connection */
export type ReviewListToReviewListConnectionEdge = Edge & ReviewListConnectionEdge & {
...
export type ReviewListToReviewListConnectionPageInfo = PageInfo & ReviewListConnectionPageInfo & WpPageInfo & {
...
/** Connection between the ReviewList type and the Taxonomy type */
export type ReviewListToTaxonomyConnectionEdge = Edge & OneToOneConnection & TaxonomyConnectionEdge & {
...
/** Connection between the Review type and the reviewList type */
export type ReviewToReviewListConnection = Connection & ReviewListConnection & {
...
/** An edge in a connection */
export type ReviewToReviewListConnectionEdge = Edge & ReviewListConnectionEdge & {
...
export type ReviewToReviewListConnectionPageInfo = PageInfo & ReviewListConnectionPageInfo & WpPageInfo & {
...
/** Connection between the Review type and the TermNode type */
export type ReviewToTermNodeConnection = Connection & TermNodeConnection & {
...
/** An edge in a connection */
export type ReviewToTermNodeConnectionEdge = Edge & TermNodeConnectionEdge & {
...
export type ReviewToTermNodeConnectionPageInfo = PageInfo & TermNodeConnectionPageInfo & WpPageInfo & {
...
export type Reviews = AcfFieldGroup & AcfFieldGroupFields & Reviews_Fields & {
  __typename?: 'Reviews';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
...
export type ReviewsReview = AcfFieldGroup & AcfFieldGroupFields & ReviewsReview_Fields & {
...
/** Connection between the RootQuery type and the AboutItem type */
export type RootQueryToAboutItemConnection = AboutItemConnection & Connection & {
...
/** An edge in a connection */
export type RootQueryToAboutItemConnectionEdge = AboutItemConnectionEdge & Edge & {
...
export type RootQueryToAboutItemConnectionPageInfo = AboutItemConnectionPageInfo & PageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the CommonFragment type */
export type RootQueryToCommonFragmentConnection = CommonFragmentConnection & Connection & {
...
/** An edge in a connection */
export type RootQueryToCommonFragmentConnectionEdge = CommonFragmentConnectionEdge & Edge & {
...
export type RootQueryToCommonFragmentConnectionPageInfo = CommonFragmentConnectionPageInfo & PageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the confidentialityPolicy type */
export type RootQueryToConfidentialityPolicyConnection = ConfidentialityPolicyConnection & Connection & {
...
/** An edge in a connection */
export type RootQueryToConfidentialityPolicyConnectionEdge = ConfidentialityPolicyConnectionEdge & Edge & {
...
export type RootQueryToConfidentialityPolicyConnectionPageInfo = ConfidentialityPolicyConnectionPageInfo & PageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the ContactItem type */
export type RootQueryToContactItemConnection = Connection & ContactItemConnection & {
...
/** An edge in a connection */
export type RootQueryToContactItemConnectionEdge = ContactItemConnectionEdge & Edge & {
...
export type RootQueryToContactItemConnectionPageInfo = ContactItemConnectionPageInfo & PageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the FeedbackItem type */
export type RootQueryToFeedbackItemConnection = Connection & FeedbackItemConnection & {
...
/** An edge in a connection */
export type RootQueryToFeedbackItemConnectionEdge = Edge & FeedbackItemConnectionEdge & {
...
export type RootQueryToFeedbackItemConnectionPageInfo = FeedbackItemConnectionPageInfo & PageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the FooterItem type */
export type RootQueryToFooterItemConnection = Connection & FooterItemConnection & {
...
/** An edge in a connection */
export type RootQueryToFooterItemConnectionEdge = Edge & FooterItemConnectionEdge & {
...
export type RootQueryToFooterItemConnectionPageInfo = FooterItemConnectionPageInfo & PageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the Fragment type */
export type RootQueryToFragmentConnection = Connection & FragmentConnection & {
...
/** An edge in a connection */
export type RootQueryToFragmentConnectionEdge = Edge & FragmentConnectionEdge & {
...
export type RootQueryToFragmentConnectionPageInfo = FragmentConnectionPageInfo & PageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the HeroItem type */
export type RootQueryToHeroItemConnection = Connection & HeroItemConnection & {
...
/** An edge in a connection */
export type RootQueryToHeroItemConnectionEdge = Edge & HeroItemConnectionEdge & {
...
export type RootQueryToHeroItemConnectionPageInfo = HeroItemConnectionPageInfo & PageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the Main type */
export type RootQueryToMainConnection = Connection & MainConnection & {
...
/** An edge in a connection */
export type RootQueryToMainConnectionEdge = Edge & MainConnectionEdge & {
...
export type RootQueryToMainConnectionPageInfo = MainConnectionPageInfo & PageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the Messenger type */
export type RootQueryToMessengerConnection = Connection & MessengerConnection & {
...
/** An edge in a connection */
export type RootQueryToMessengerConnectionEdge = Edge & MessengerConnectionEdge & {
...
export type RootQueryToMessengerConnectionPageInfo = MessengerConnectionPageInfo & PageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the NavigationItem type */
export type RootQueryToNavigationItemConnection = Connection & NavigationItemConnection & {
...
/** An edge in a connection */
export type RootQueryToNavigationItemConnectionEdge = Edge & NavigationItemConnectionEdge & {
...
export type RootQueryToNavigationItemConnectionPageInfo = NavigationItemConnectionPageInfo & PageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the NotFound type */
export type RootQueryToNotFoundConnection = Connection & NotFoundConnection & {
...
/** An edge in a connection */
export type RootQueryToNotFoundConnectionEdge = Edge & NotFoundConnectionEdge & {
...
export type RootQueryToNotFoundConnectionPageInfo = NotFoundConnectionPageInfo & PageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the PrivacyPolicyItem type */
export type RootQueryToPrivacyPolicyItemConnection = Connection & PrivacyPolicyItemConnection & {
...
/** An edge in a connection */
export type RootQueryToPrivacyPolicyItemConnectionEdge = Edge & PrivacyPolicyItemConnectionEdge & {
...
export type RootQueryToPrivacyPolicyItemConnectionPageInfo = PageInfo & PrivacyPolicyItemConnectionPageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the Recruit type */
export type RootQueryToRecruitConnection = Connection & RecruitConnection & {
...
/** An edge in a connection */
export type RootQueryToRecruitConnectionEdge = Edge & RecruitConnectionEdge & {
...
export type RootQueryToRecruitConnectionPageInfo = PageInfo & RecruitConnectionPageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the recruitList type */
export type RootQueryToRecruitListConnection = Connection & RecruitListConnection & {
...
/** An edge in a connection */
export type RootQueryToRecruitListConnectionEdge = Edge & RecruitListConnectionEdge & {
...
export type RootQueryToRecruitListConnectionPageInfo = PageInfo & RecruitListConnectionPageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the reviewList type */
export type RootQueryToReviewListConnection = Connection & ReviewListConnection & {
...
/** An edge in a connection */
export type RootQueryToReviewListConnectionEdge = Edge & ReviewListConnectionEdge & {
...
export type RootQueryToReviewListConnectionPageInfo = PageInfo & ReviewListConnectionPageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the SkillCategory type */
export type RootQueryToSkillCategoryConnection = Connection & SkillCategoryConnection & {
...
/** An edge in a connection */
export type RootQueryToSkillCategoryConnectionEdge = Edge & SkillCategoryConnectionEdge & {
...
export type RootQueryToSkillCategoryConnectionPageInfo = PageInfo & SkillCategoryConnectionPageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the Skill type */
export type RootQueryToSkillConnection = Connection & SkillConnection & {
...
/** An edge in a connection */
export type RootQueryToSkillConnectionEdge = Edge & SkillConnectionEdge & {
...
export type RootQueryToSkillConnectionPageInfo = PageInfo & SkillConnectionPageInfo & WpPageInfo & {
...
/** Connection between the RootQuery type and the SocialNetwork type */
export type RootQueryToSocialNetworkConnection = Connection & SocialNetworkConnection & {
...
/** An edge in a connection */
export type RootQueryToSocialNetworkConnectionEdge = Edge & SocialNetworkConnectionEdge & {
...
export type RootQueryToSocialNetworkConnectionPageInfo = PageInfo & SocialNetworkConnectionPageInfo & WpPageInfo & {
...
/** The Skill type */
export type Skill = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithPageAttributes & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Skill';
  /** Returns ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  ancestors?: Maybe<HierarchicalContentNodeToContentNodeAncestorsConnection>;
  /** Connection between the HierarchicalContentNode type and the ContentNode type */
...
export type SkillAddons = AcfFieldGroup & AcfFieldGroupFields & SkillAddons_Fields & {
...
export type SkillCategory = DatabaseIdentifier & HierarchicalNode & HierarchicalTermNode & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & WithAcfSkillAddons & {
...
export type SkillCategoryToAncestorsSkillCategoryConnection = Connection & SkillCategoryConnection & {
...
/** An edge in a connection */
export type SkillCategoryToAncestorsSkillCategoryConnectionEdge = Edge & SkillCategoryConnectionEdge & {
...
export type SkillCategoryToAncestorsSkillCategoryConnectionPageInfo = PageInfo & SkillCategoryConnectionPageInfo & WpPageInfo & {
...
/** Connection between the SkillCategory type and the ContentNode type */
export type SkillCategoryToContentNodeConnection = Connection & ContentNodeConnection & {
...
/** An edge in a connection */
export type SkillCategoryToContentNodeConnectionEdge = ContentNodeConnectionEdge & Edge & {
...
export type SkillCategoryToContentNodeConnectionPageInfo = ContentNodeConnectionPageInfo & PageInfo & WpPageInfo & {
...
/** Connection between the SkillCategory type and the SkillCategory type */
export type SkillCategoryToParentSkillCategoryConnectionEdge = Edge & OneToOneConnection & SkillCategoryConnectionEdge & {
...
/** Connection between the SkillCategory type and the SkillCategory type */
export type SkillCategoryToSkillCategoryConnection = Connection & SkillCategoryConnection & {
...
/** An edge in a connection */
export type SkillCategoryToSkillCategoryConnectionEdge = Edge & SkillCategoryConnectionEdge & {
...
export type SkillCategoryToSkillCategoryConnectionPageInfo = PageInfo & SkillCategoryConnectionPageInfo & WpPageInfo & {
...
/** Connection between the SkillCategory type and the Skill type */
export type SkillCategoryToSkillConnection = Connection & SkillConnection & {
...
/** An edge in a connection */
export type SkillCategoryToSkillConnectionEdge = Edge & SkillConnectionEdge & {
...
export type SkillCategoryToSkillConnectionPageInfo = PageInfo & SkillConnectionPageInfo & WpPageInfo & {
...
/** Connection between the SkillCategory type and the Taxonomy type */
export type SkillCategoryToTaxonomyConnectionEdge = Edge & OneToOneConnection & TaxonomyConnectionEdge & {
...
/** Connection between the Skill type and the Skill type */
export type SkillToPreviewConnectionEdge = Edge & OneToOneConnection & SkillConnectionEdge & {
...
/** Connection between the Skill type and the SkillCategory type */
export type SkillToSkillCategoryConnection = Connection & SkillCategoryConnection & {
...
/** An edge in a connection */
export type SkillToSkillCategoryConnectionEdge = Edge & SkillCategoryConnectionEdge & {
...
export type SkillToSkillCategoryConnectionPageInfo = PageInfo & SkillCategoryConnectionPageInfo & WpPageInfo & {
...
/** Connection between the Skill type and the TermNode type */
export type SkillToTermNodeConnection = Connection & TermNodeConnection & {
...
/** An edge in a connection */
export type SkillToTermNodeConnectionEdge = Edge & TermNodeConnectionEdge & {
...
export type SkillToTermNodeConnectionPageInfo = PageInfo & TermNodeConnectionPageInfo & WpPageInfo & {
...
export type SocialNetwork = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfContentAddons & {
...
/** Connection between the SocialNetwork type and the SocialNetwork type */
export type SocialNetworkToPreviewConnectionEdge = Edge & OneToOneConnection & SocialNetworkConnectionEdge & {
...
export type GetSeoQuery = { __typename?: 'RootQuery', pageBy?: { __typename?: 'Page', seo?: { __typename?: 'PostTypeSEO', title?: string | null, metaDesc?: string | null } | null, translation?: { __typename?: 'Page', seo?: { __typename?: 'PostTypeSEO', title?: string | null, metaDesc?: string | null } | null } | null } | null };
