...
} elseif (in_array($position, ['header', 'mobile', 'toolbar-right', 'toolbar-left', 'logo'])) {
...
if (!preg_match('/^(toolbar-left|toolbar-right|navbar|header|logo|logo-mobile|debug)$/', $position)) {
