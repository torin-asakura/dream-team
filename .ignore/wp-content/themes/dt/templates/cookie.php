...
<?php if ($config('~cookie.type') === 'bar') : ?>
    ...
    <div class="uk-section uk-section-xsmall uk-section-<?= $config('~cookie.bar_style') ?><?= $config('~cookie.bar_position') === 'bottom' ? ' uk-position-bottom uk-position-fixed uk-position-z-index' : ' uk-position-relative' ?>">
...
<?php else : ?>
    ...
    <div class="uk-notification uk-notification-<?= $config('~cookie.notification_position') ?>">
