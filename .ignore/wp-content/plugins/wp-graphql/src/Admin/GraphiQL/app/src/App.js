...
const storedCodeExporterPaneState =
  typeof parameters.codeExporterIsOpen !== `undefined`
    ? parameters.codeExporterIsOpen === `false`
      ...
      : true
    : window.localStorage
    ? window.localStorage.getItem(`graphiql:graphiqlCodeExporterOpen`) === `true`
    : false
...
class App extends React.Component {
      ...
      if (this.state.query === null) {
        try {
          ...
          if (siteMetadataType) {
            ...
            if (titleField) {
              newState.query = generateDefaultFallbackQuery(QUERY_EXAMPLE_SITEMETADATA_TITLE)
            }
          }
  ...
  _handleToggleExplorer = () => {
    ...
    if (window.localStorage) {
      window.localStorage.setItem(`graphiql:graphiqlExplorerOpen`, newExplorerIsOpen)
    }
  ...
  _handleToggleExporter = () => {
    ...
    if (window.localStorage) {
      window.localStorage.setItem(`graphiql:graphiqlCodeExporterOpen`, newCodeExporterIsOpen)
    }
