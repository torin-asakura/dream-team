    ...
    $.extend(Timepicker.prototype, {
        ...
        if (0 === e.find('div.ui-timepicker-div').length && t.showTimepicker) {
          ...
          for (u = 0, c = this.units.length; u < c; u++) {
            if (
              ...
              if (
                ((d += '<div style="padding-left: 1px"><table class="ui-tpicker-grid-label"><tr>'),
                'hour' === s)
              )
      ...
      _onTimeChange: function () {
        if (this._defaults.showTimepicker) {
          var e = !!this.hour_slider && this.control.value(this, this.hour_slider, 'hour'),
            ...
            s =
              !!this.millisec_slider && this.control.value(this, this.millisec_slider, 'millisec'),
            n =
              !!this.microsec_slider && this.control.value(this, this.microsec_slider, 'microsec'),
          ...
          var u = r[e < 12 ? 'amNames' : 'pmNames'][0],
            c =
              ...
              (this.ampm.length > 0 &&
                e < 12 != ($.inArray(this.ampm.toUpperCase(), this.amNames) !== -1)) ||
      ...
      ($.datepicker._setDateDatepicker = function (e, t) {
        ...
        if (i) {
          ...
          var n = this._get(i, 'timepicker'),
            a
          s instanceof Date
            ? ((a = new Date(s.getTime())), a.setMicroseconds(s.getMicroseconds()))
            : (a = s),
            n &&
              a &&
              (n.support.timezone ||
      ...
      ($.datepicker._optionDatepicker = function (e, t, i) {
        ...
        if (a) {
          ...
          for (m in c)
            c.hasOwnProperty(m) && ((u[m] = c[m]), n || (n = $.extend({}, t)), delete n[m])
    ...
    ;($.timepicker = new Timepicker()),
      ($.timepicker.timezoneOffsetString = function (e, t) {
        ...
        var i = e,
          ...
          a = t ? ':' : '',
          r =
            (i >= 0 ? '+' : '-') + ('0' + Math.abs(n)).slice(-2) + a + ('0' + Math.abs(s)).slice(-2)
        return '+00:00' === r ? 'Z' : r
      }),
