...
;// CONCATENATED MODULE: ../../../../.yarn/__virtual__/@ui-video-virtual-84460127bc/1/frontend/ui/video/src/video.component.tsx
...
const StyledVideo = styled_default().video({
  position: 'absolute',
  left: '50%',
  transform: 'translate(-50%, -50%)',
  zIndex: -1
}, dist.layout, dist.position);
...
const Video = (_ref) => {
  let {
    ...
    mime = []
      ...
      props = _objectWithoutProperties(_ref, ["src", "mime"]);

  return /*#__PURE__*/jsx_runtime_.jsx(StyledVideo, _objectSpread(_objectSpread({}, props), {}, {
    children: src && typeof src === 'string' && typeof mime === 'string' ? /*#__PURE__*/jsx_runtime_.jsx("source", {
      src: src,
      type: mime
    }) : src.map((item, index) => /*#__PURE__*/jsx_runtime_.jsx("source", {
      src: item,
      type: mime[index]
    }))
  }));
...
const Item = ({
  ...
  var _category$skillAddons, _category$skillAddons2;
      ...
      children: [/*#__PURE__*/jsx_runtime_.jsx(layout_src.Layout, {
        ...
        children: /*#__PURE__*/jsx_runtime_.jsx(layout_src.Layout, {
          ...
          children: /*#__PURE__*/jsx_runtime_.jsx(image_src/* Image */.E, {
            src: (category === null || category === void 0 ? void 0 : (_category$skillAddons = category.skillAddons) === null || _category$skillAddons === void 0 ? void 0 : (_category$skillAddons2 = _category$skillAddons.ikonka) === null || _category$skillAddons2 === void 0 ? void 0 : _category$skillAddons2.link) || ''
          })
        })
      }), /*#__PURE__*/jsx_runtime_.jsx(layout_src.Layout, {
        flexBasis: 24
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(layout_src.Box, {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)(condition_src/* Condition */.g, {
      ...
      children: [/*#__PURE__*/jsx_runtime_.jsx(layout_src.Row, {
        ...
        children: /*#__PURE__*/jsx_runtime_.jsx(image_src/* Image */.E, {
          alt: title,
          src: featuredImage === null || featuredImage === void 0 ? void 0 : (_featuredImage$node = featuredImage.node) === null || _featuredImage$node === void 0 ? void 0 : _featuredImage$node.link,
          contain: true
        })
      }), /*#__PURE__*/jsx_runtime_.jsx(layout_src.Layout, {
        flexBasis: 64
      ...
      children: [/*#__PURE__*/jsx_runtime_.jsx(layout_src.Row, {
        ...
        children: /*#__PURE__*/jsx_runtime_.jsx(image_src/* Image */.E, {
          alt: title,
          src: featuredImage === null || featuredImage === void 0 ? void 0 : (_featuredImage$node2 = featuredImage.node) === null || _featuredImage$node2 === void 0 ? void 0 : _featuredImage$node2.link,
          contain: true
        })
      }), /*#__PURE__*/jsx_runtime_.jsx(layout_src.Layout, {
        flexBasis: 64
        ...
        children: /*#__PURE__*/jsx_runtime_.jsx(image_src/* Image */.E, {
          alt: title,
          src: featuredImage === null || featuredImage === void 0 ? void 0 : (_featuredImage$node3 = featuredImage.node) === null || _featuredImage$node3 === void 0 ? void 0 : _featuredImage$node3.link,
          contain: true
        })
      })]
    })]
...
function layer_component_objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = layer_component_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }

function layer_component_objectWithoutPropertiesLoose(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } return target; }
...
const Layer = (_ref) => {
  let {
    ...
    left = 0
      ...
      props = layer_component_objectWithoutProperties(_ref, ["children", "visible", "onClose", "scroll", "opacity", "center", "top", "left"]);
...
function landing_reviews_src_data_validate_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function landing_reviews_src_data_validate_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { landing_reviews_src_data_validate_ownKeys(Object(source), true).forEach(function (key) { landing_reviews_src_data_validate_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { landing_reviews_src_data_validate_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function landing_reviews_src_data_validate_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
const src_data_validate_validate = target => src_data_validate_stringProps.reduce((acc, prop) => {
  if (target[prop]) {
    return landing_reviews_src_data_validate_objectSpread(landing_reviews_src_data_validate_objectSpread({}, acc), {}, {
